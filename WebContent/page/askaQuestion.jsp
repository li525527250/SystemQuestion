					...
					<table class="altrowstable" id="alternatecolor">
							<tr>
								<td class="td"><input type="hidden" name="quid"
									...
									<h3>提问内容</h3></td>
								<td class="td"><textarea id="wenti" name="wenti" rows="10" cols="70"></textarea></td>
							</tr>
							<tr>
								<td class="td"><h3>上传图片</h3></td>
								<td class="td"><div id="addCommodityIndex">
											<!--input-group start-->
							...
							<tr>
								<td class="td"><h3>提交问题</h3></td>
								<td align="center"><input type="submit" value="提交问题" onclick=f1();></td>
							</tr>
					</table>
					<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
				</form>
